...
if (!function_exists('get_admin_email')) {
    ...
    function get_admin_detail() {
        $array = array('email' => 'info@stacksclassifieds.com', 'name' => 'StacksClassifieds');
        return $array;
    }

}
if (!function_exists('get_admin_email_verification')) {

    function get_admin_email_verification() {
        $array = array('email' => 'verification@stacksclassifieds.com', 'name' => 'StacksClassifieds');
        return $array;
    }
...
if (!function_exists('cms_block')) {
    ...
    function cms_block($block_name) {
        ...
        $session_lang_shortcode = 'description_' . Do_language::GetSessionLang();

        return $data[0]["{$session_lang_shortcode}"];

        //return $data[0]['description_' . Do_language::GetSessionLang()];
//        $return = @$data[0][$ci->session->userdata('language_shortcode')];
//        if (empty($return)) {
//            return @$data[0]['description_'];
