...
<section class="main_div">
    <div class="main_area">
        <div >
            ...
            <div id="currentUser">
                <?php echo $this->session->userdata('primary_email') ?><br>
                <a style="font-size:12px;font-weight:normal;" href="<?php echo site_url(); ?>home/affiliate_number_account/<?php echo $user_id ?>">affiliate program</a>
                <span style="color:#f00;font-size:10px;font-weight:bold;}">(new)</span>
                <div id="postMultipleAds" style="margin:0"><a href="<?php echo site_url(); ?>ad_type/index/multiple">Post sponsor ads in multiple cities</a></div>
            </div>
                            ...
                            <div class="manageAdBox" <?php echo $bg_color; ?>>
                                ...
                                <div class="manageAdBoxDetails">
                                    ...
                                    <p class="adDetails">
                                        ...
                                        <?php echo $category_name[0]['category_name_en']; ?>
                                    </p>
