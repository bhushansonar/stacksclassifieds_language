                            ...
                            <tr>
                                <td valign="top">
                                    <table cellspacing="0" cellpadding="0" border="0" width="650">
                                        <tr>
                                            <td colspan="2">
                                                <h2 style="color:#FFF;">Reply to Posts</h2>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="background-color:#FFFFFF; color:#000000; text-align:left; font-size:13px; padding:5px; font-weight:bold;" >
                                                ...
                                                <div>
                                                    <b>This person has contacted you anonymously through StacksClassifieds.com. If you believe their email is a scam, spam or inappropriate, please forward this email to <?php echo $from_email ?></b>
                                                </div>
