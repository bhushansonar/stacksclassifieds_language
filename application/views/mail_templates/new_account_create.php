                            ...
                            <tr>
                                <td valign="top">
                                    <table cellspacing="0" cellpadding="0" border="0" width="650">
                                        <tr>
                                            <td colspan="2">
                                                <h3 style="color:#FFF;">New Account Created in StacksClassifieds!</h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="background-color:#FFFFFF; color:#000000; text-align:left; font-size:13px; padding:5px; font-weight:bold;" >
                                                <p style="color:#000 !important"><?php echo $email; ?>  has been created new account in StacksClassified.com</p>
