...
//save the columns names in a array that we will use as filter
                ...
                echo form_open('admin/languagekeyword', $attributes);
...
// echo form_dropdown('order', $options_language, $order, 'class="span2"');
                ...
                if ($search_string_selected) {
                    echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="' . site_url("admin/languagekeyword/") . '">Reset</a>';
                }
                echo form_close();
                ?>
...
//                        echo '<td>' . $fr . '</td>';
                  ...
                  <a  href="' . site_url("admin") . '/languagekeyword/update/' . $row['language_keyword_id'] . '" class="btn btn-info">view & edit</a>

                </td>';
                        echo '</tr>';
                    }
                    /* <a href="'.site_url("admin").'/languagekeyword/delete/'.$row['language_keyword_id'].'" class="btn btn-danger complexConfirm">delete</a> */
                    ?>
