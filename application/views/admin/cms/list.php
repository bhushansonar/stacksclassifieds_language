...
if ($search_string_selected) {
    echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="' . site_url("admin/cms/") . '">Reset</a>';
}
echo form_close();
?>
...
foreach ($language as $row) {
    ...
    echo '<td class="crud-actions">
                  <a  href="' . site_url("admin") . '/cms/update/' . $row['cms_id'] . '" class="btn btn-info">view & edit</a>
                  <a href="' . site_url("admin") . '/cms/delete/' . $row['cms_id'] . '" class="btn btn-danger complexConfirm">delete</a>
                </td>';
    echo '</tr>';
}
?>
