...
//save the columns names in a array that we will use as filter
                ...
                <select name="order" class="span2">
                    ...
                    <option <?php echo ($order == 'type_of_membership') ? 'selected="selected"' : "" ?> value="type_of_membership">Type</option>
            ...
            <table class="table table-striped table-bordered table-condensed">
                <thead>
                    <tr>
                        ...
                        <th class="yellow header headerSortDown">Affiliate Price for Register</th>
                        <th class="yellow header headerSortDown">Affiliate Price for Posted ads</th>
                ...
                <tbody>
                    ...
                    foreach ($user as $row) {
                        ...
                        echo '<td>' . $row['register_price'] . '</td>';
                        echo '<td>' . $row['posted_ad_price'] . '</td>';
