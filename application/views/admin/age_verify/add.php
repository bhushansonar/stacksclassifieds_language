...
<div class="container top">
    ...
    <div class="page-header">
        <h2>
            Adding Age Verify Description<?php //echo ucfirst($this->uri->segment(2));  ?>
        </h2>
    </div>
    ...
    echo form_open('admin/age_verify/add', $attributes);
    ?>
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="tinymce ckeditor" id="editor_cms" name="description"></textarea>
            </div>
        </div>
