<div class="container top">
    ...
    echo form_open_multipart('admin/sitelanguage/update/' . $this->uri->segment(4) . '', $attributes);
    ?>
    <fieldset>
        ...
        <div class="form-actions">
            ...
            <?php /* ?><a data-rel="Please make sure." href="<?php echo site_url("admin")?>'/sitelanguage/delete/'<?php echo $this->uri->segment(3); ?>" class="btn btn-danger complexConfirm">delete</a><?php */ ?>
        </div>
    </fieldset>
