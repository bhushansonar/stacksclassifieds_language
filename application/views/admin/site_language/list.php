...
echo form_open('admin/sitelanguage', $attributes);
...
if ($search_string_selected) {
    echo '<a style="margin-left: 12px;vertical-align: middle;" class="btn" href="' . site_url("admin/sitelanguage/") . '">Reset</a>';
}
echo form_close();
?>
...
foreach ($language as $row) {
    ...
    echo '<td style="text-align:center;" class="crud-actions">
                  <a  href="' . site_url("admin") . '/sitelanguage/update/' . $row['site_language_id'] . '" class="btn btn-info">view & edit</a>
                </td>';
    echo '</tr>';
}
?>
