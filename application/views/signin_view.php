    ...
    <section>
        ...
        <div class="main_area login_wi">
            <div class="form_area lo">
                <article>
                    <h1><?php echo _clang(LOGIN); ?></h1>
                    <form action="<?php echo site_url('signin/validate_credentials_front') ?>" method="post" name="signin_account">
                        <div style="margin:1em 0;"><label><?php echo _clang(USERNAME); ?><span class="star">*</span></label><input type="text" class="login_input" value="" name="username"></div>
                        <div style="margin:1em 0;"><label><?php echo _clang(PASSWORD); ?><span class="star">*</span></label><input type="password" class="login_input" value="" name="password"></div>
                        ...
                        <div>
                            ...
                            <div style="display: inline-block;float: right;
                                 margin-top: 7%;">
                                <a href="<?php echo site_url('signup') ?>"><?php echo _clang(CREATE_ACCOUNT); ?></a>
                                <!--<a href="<?php echo site_url('home/set_pass_mail') ?>">Reset Password</a>-->
                            </div>
                        </div>
                    </form>
                </article>
