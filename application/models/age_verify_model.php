<?php
class age_verify_model extends CI_Model {
    /**
    ...
    */
    public function get_cms_by_id($id)
    {
		...
		$this->db->where('age_verify_id', $id);
		$query = $this->db->get();
    ...
    */
    public function get_cms($search_string=null, $order=null, $order_type='DESC', $limit_start=null, $limit_end=null,$wherestatus=null)
    {
		...
		$this->db->group_by('age_verify_id');

		if($order){
			$this->db->order_by($order, $order_type);
		}else{
		    $this->db->order_by('age_verify_id', $order_type);
		}
    ...
    * @return boolean 
    */
    function store_age_verify($data)
    {
		$insert = $this->db->insert('age_verify', $data);
	    return $insert;
	}
    ...
    * @return boolean
    */
    function update_age_verify($id, $data)
    {
		$this->db->where('age_verify_id', $id);
		$this->db->update('age_verify', $data);
		$report = array();
    ...
    * @return boolean
    */
	function delete_age_verify($id){
		$this->db->where('age_verify_id', $id);
		$this->db->delete('age_verify'); 
	}
