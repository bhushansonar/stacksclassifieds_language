...
class Admin_language_keyword extends CI_Controller {
    ...
    const VIEW_FOLDER = 'admin/language_keyword';
    ...
    public function __construct() {
        ...
        if (!Access_level::get_access('languagekeyword')) {
    ...
    public function index() {
        ...
        $config['base_url'] = base_url() . 'admin/languagekeyword';
...
//die;
        ...
        //load the view
        $data['main_content'] = 'admin/language_keyword/list';
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($this->language_keyword_model->store_language_keyword($_POST)) {
                    ...
                    redirect('admin/languagekeyword/');
...
//$data['main_content'] = 'admin/language_keyword/list';
        ...
        $data['main_content'] = 'admin/language_keyword/add';
        $this->load->view('admin/includes/template', $data);
    }
    ...
    public function update() {
        ...
        //load the view
        $data['main_content'] = 'admin/language_keyword/edit';
        $this->load->view('admin/includes/template', $data);
    }
