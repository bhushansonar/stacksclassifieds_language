...
//        $this->load->library('table');
    ...
    function getAlltitle() {
        ...
        $where_top_ads_count = "AND category_id={$category_id}";
        $count_top_ads = $this->common_model->getFieldData('category', 'top_ads_counter', $where_top_ads_count);
        $counter = $count_top_ads + 1;
        $data_to_store_ads = array('top_ads_counter' => $counter);
        $this->common_model->update_by_field('category', 'category_id', $category_id, $data_to_store_ads);
